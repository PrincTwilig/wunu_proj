...
void print_b1()
{
	...
	// вивести все в b1
	cout << 1 << "\t" << b1.n1[0] << "\t" << b1.t1[0] << "\t" << b1.T1[0] << "\t" << b1.dT1[0] << "\t" << b1.n2[0] << "\t" << b1.t2[0] << "\t" << b1.T2[0] << "\t" << b1.dT2[0] << "\t" << b1.g[0] << "\t" << b1.dg[0] << "\t" << '?' << endl;
	cout << 2 << "\t" << b1.n1[1] << "\t" << b1.t1[1] << "\t" << b1.T1[1] << "\t" << b1.dT1[1] << "\t" << b1.n2[1] << "\t" << b1.t2[1] << "\t" << b1.T2[1] << "\t" << b1.dT2[1] << "\t" << b1.g[1] << "\t\t" << b1.dg[1] << "\t" << '?' << endl;
	cout << 3 << "\t" << b1.n1[2] << "\t" << b1.t1[2] << "\t" << b1.T1[2] << "\t" << b1.dT1[2] << "\t" << b1.n2[2] << "\t" << b1.t2[2] << "\t" << b1.T2[2] << "\t" << b1.dT2[2] << "\t" << b1.g[2] << "\t\t" << b1.dg[2] << "\t" << '?' << endl;
	cout << 4 << "\t" << b1.n1[3] << "\t" << b1.t1[3] << "\t" << b1.T1[3] << "\t" << b1.dT1[3] << "\t" << b1.n2[3] << "\t" << b1.t2[3] << "\t" << b1.T2[3] << "\t" << b1.dT2[3] << "\t" << b1.g[3] << "\t\t" << b1.dg[3] << "\t" << '?' << endl;
	cout << "\ng= " << b1.g[3] << " +- " << b1.dg[3] << endl;
	cout << "E= " << b1.dg[3] / b1.g[3] << endl;
	system("pause");
}
...
void print_b2()
{
	...
	cout << "No\tn1\tt1\tT1\tdT1\t|n2\tt2\tT2\tdT2\tg\t\tdg\tE" << endl;
	// вивести все в b2
	cout << 1 << "\t" << b2.n1[0] << "\t" << b2.t1[0] << "\t" << b2.T1[0] << "\t" << b2.dT1[0] << "\t" << b2.n2[0] << "\t" << b2.t2[0] << "\t" << b2.T2[0] << "\t" << b2.dT2[0] << "\t" << b2.g[0] << "\t" << b2.dg[0] << "\t" << '?' << endl;
	cout << 2 << "\t" << b2.n1[1] << "\t" << b2.t1[1] << "\t" << b2.T1[1] << "\t" << b2.dT1[1] << "\t" << b2.n2[1] << "\t" << b2.t2[1] << "\t" << b2.T2[1] << "\t" << b2.dT2[1] << "\t" << b2.g[1] << "\t\t" << b2.dg[1] << "\t" << '?' << endl;
	cout << 3 << "\t" << b2.n1[2] << "\t" << b2.t1[2] << "\t" << b2.T1[2] << "\t" << b2.dT1[2] << "\t" << b2.n2[2] << "\t" << b2.t2[2] << "\t" << b2.T2[2] << "\t" << b2.dT2[2] << "\t" << b2.g[2] << "\t\t" << b2.dg[2] << "\t" << '?' << endl;
	cout << 4 << "\t" << b2.n1[3] << "\t" << b2.t1[3] << "\t" << b2.T1[3] << "\t" << b2.dT1[3] << "\t" << b2.n2[3] << "\t" << b2.t2[3] << "\t" << b2.T2[3] << "\t" << b2.dT2[3] << "\t" << b2.g[3] << "\t\t" << b2.dg[3] << "\t" << '?' << endl;
	cout << "\ng= " << b2.g[3] << " +- " << b2.dg[3] << endl;
	cout << "E= " << b2.dg[3] / b2.g[3] << endl;
	system("pause");
}
...
void print_b3()
{
	...
	cout << "No\tn1\tt1\tT1\tdT1\t|n2\tt2\tT2\tdT2\tg\t\tdg\tE" << endl;
	// вивести все в b3
	cout << 1 << "\t" << b3.n1[0] << "\t" << b3.t1[0] << "\t" << b3.T1[0] << "\t" << b3.dT1[0] << "\t" << b3.n2[0] << "\t" << b3.t2[0] << "\t" << b3.T2[0] << "\t" << b3.dT2[0] << "\t" << b3.g[0] << "\t" << b3.dg[0] << "\t" << '?' << endl;
	cout << 2 << "\t" << b3.n1[1] << "\t" << b3.t1[1] << "\t" << b3.T1[1] << "\t" << b3.dT1[1] << "\t" << b3.n2[1] << "\t" << b3.t2[1] << "\t" << b3.T2[1] << "\t" << b3.dT2[1] << "\t" << b3.g[1] << "\t\t" << b3.dg[1] << "\t" << '?' << endl;
	cout << 3 << "\t" << b3.n1[2] << "\t" << b3.t1[2] << "\t" << b3.T1[2] << "\t" << b3.dT1[2] << "\t" << b3.n2[2] << "\t" << b3.t2[2] << "\t" << b3.T2[2] << "\t" << b3.dT2[2] << "\t" << b3.g[2] << "\t\t" << b3.dg[2] << "\t" << '?' << endl;
	cout << 4 << "\t" << b3.n1[3] << "\t" << b3.t1[3] << "\t" << b3.T1[3] << "\t" << b3.dT1[3] << "\t" << b3.n2[3] << "\t" << b3.t2[3] << "\t" << b3.T2[3] << "\t" << b3.dT2[3] << "\t" << b3.g[3] << "\t\t" << b3.dg[3] << "\t" << '?' << endl;
	cout << "\ng= " << b3.g[3] << " +- " << b3.dg[3] << endl;
	cout << "E= " << b3.dg[3] / b3.g[3] << endl;
	system("pause");
}